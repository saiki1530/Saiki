                    ...
                    <ul class="metismenu" id="menu1">
                        <li>
                            ...
                            <ul class="submenu-angle " aria-expanded="true">
                                <li><a title="Dashboard v.1" href="manage_product.php"><span class="mini-sub-pro">Dashboard
                                            </span></a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Bar Charts" href="#"> <span class="mini-sub-pro">Bar Charts</span></a>
                                </li>
                                                        ...
                                                        <div class="tab-content custom-bdr-nt">
                                                            ...
                                                            <div id="Projects" class="tab-pane fade">
                                                                <div class="projects-settings-wrap">
                                                                    <div class="note-heading-indicate">
                                                                        <h2><i class="fa fa-cube"></i> Recent Activity
                                                                        </h2>
                        ...
                        <div class="hpanel responsive-mg-b-30">
                            <div class="panel-body file-manager-usac">
                                ...
                                <div class="progress full m-t-xs">
                                    <div style="width: 65%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="65"
